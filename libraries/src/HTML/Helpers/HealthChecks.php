...
abstract class HealthChecks
{
    ...
    /**
     * Method to generate html code for a list of reports
     *
    ...
    public static function reports($reports)
    {
        ...
        foreach ($reports as $report) {
            $html[] = HTMLHelper::_('healthchecks.report', $report);
        }
    ...
    /**
     * Method to generate html code for a report
     *
     * @param   array  $report  Report properties
     *
     * @return  string
     *
     * @since   __DEPLOY_VERSION__
    ...
    {
        if (!static::canAccess($report)) {
            return '';
        }

        // Instantiate a new FileLayout instance and render the layout
        $layout = new FileLayout('joomla.healthchecks.report');

        return $layout->render($report);
    }
